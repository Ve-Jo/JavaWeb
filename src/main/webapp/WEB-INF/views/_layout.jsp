...
<header>
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="<%=contextPath%>/img/Java_Logo.png" alt="Logo" class="d-inline-block align-text-top">
            Java-Web
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<%= contextPath %>/log">Log</a>
                </li>
            </ul>
        </div>
    </div>
...
<footer class="footer mt-auto py-3 bg-light">
    <div class="container">
        <span class="text-muted">© 2024 Java Web SPU221. All rights reserved.</span>
    </div>
</footer>
